...
# Go
curl -L -o golang.tar.gz https://dl.google.com/go/go1.12.9.linux-amd64.tar.gz
checksum golang.tar.gz ac2a6efcc1f5ec8bdc0db0a988bb1d301d64b6d61b7e8d9e42f662fbb75a2b9b
